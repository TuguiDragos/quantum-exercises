...
limit is 15 minutes; raise it with `uv run qx run 11 --timeout 3600`.

## What you should expect to see

If you land on real hardware or the noise-modelled simulator, `01` and `10` will
show up, at a few percent. Exercise 09 said an ideal Bell state can never produce
those. Both statements are true, and reconciling them is exercise 12.
