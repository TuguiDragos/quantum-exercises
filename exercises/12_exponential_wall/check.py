...
def _perspective(amplitudes_for, quantum_bytes_for) -> str:
    ...
    return (
        ...
        "qubits, nobody can check your answer by writing the whole statevector\n"
        "down. Methods that never write it down, tensor networks among them, do\n"
        "reach further on circuits whose structure they can exploit. And none of\n"
        "this proves by itself that a quantum computer solves anything useful\n"
        "faster, which is a separate question the field has not finished\n"
        "answering.\n\n"
