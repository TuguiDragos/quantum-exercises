"""Exercise 17 - CHSH, the experiment that settles it.

Fill in the TODOs, then run:  qx run 17
"""
...
#       Same Estimator call as exercise 15, with bell() as the circuit.
